  ...
  const slides = [
    {
      ...
      description: 'Discover the newest footwear trends with our exclusive collection',
    ...
    },
    {
      ...
      description: 'Get the latest smartphones and mobile devices at unbeatable prices',
      buttonText: 'Shop Smartphones',
      buttonLink: '/category/Smartphones',
      secondaryButtonText: 'View Deals',
      secondaryButtonLink: '/category/Smartphones',
    ...
    },
    {
      ...
      description: 'Get the best laptops and computing devices for work and play',
      buttonText: 'Shop Laptops',
      buttonLink: '/category/Laptops',
      secondaryButtonText: 'View All',
      secondaryButtonLink: '/category/Laptops',
      category: 'Laptops',
      badge: 'Hot Deal',
